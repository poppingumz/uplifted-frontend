...
const Account = () => {
  ...
  useEffect(() => {
    if (!user) return;
    fetchUserCourses(user.id).then(setCreatedCourses).catch(console.error);
    fetchEnrolledCourses(user.id).then(setEnrolledCourses).catch(console.error);
    fetchUserQuizzes(user.id).then(setQuizzes).catch(console.error);
  }, [user]);
...
/>
          ...
          <div className="tabs">
            ...
            {user.role === 'TEACHER' && (
              <>
                <button onClick={() => setActiveTab('created')} className={activeTab === 'created' ? 'active' : ''} data-cy="created-tab-btn">Courses Created</button>
          ...
          {user.role === 'TEACHER' && activeTab === 'created' && (
            <div className="account-courses">
              <div className="account-courses-header">
                ...
                <button onClick={() => navigate('/createcourse')} className="create-course-button" data-cy="create-course-btn">+ Create New Course</button>
              </div>
...
/>
          ...
          {user.role === 'TEACHER' && activeTab === 'statistics' && (
            <div className="account-courses">
              <StatisticsPanel />
            </div>
          )}
